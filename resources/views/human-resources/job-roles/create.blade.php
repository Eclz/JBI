...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Add a new position to the organization structure.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm" style="max-width: 800px;">
        <div class="card-body p-4">
            <form action="{{ route('human-resources.job-roles.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" name="salary_band_min" class="form-control @error('salary_band_min') is-invalid @enderror" value="{{ old('salary_band_min') }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" step="0.01" name="salary_band_max" class="form-control @error('salary_band_max') is-invalid @enderror" value="{{ old('salary_band_max') }}">
                        </div>
