                    ...
                    <form action="{{ route('admin.timetables.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="start_time" class="form-control" placeholder="e.g. 08:00" value="{{ old('start_time', '08:00') }}" required>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label fw-semibold">End Time <span class="text-danger">*</span></label>
                                <input type="text" name="end_time" class="form-control" placeholder="e.g. 10:00" value="{{ old('end_time', '10:00') }}" required>
                            </div>
