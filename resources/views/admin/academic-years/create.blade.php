...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Create Academic Year</h1>
            <p class="text-muted">Add a new academic year</p>
        </div>
            ...
            <form action="{{ route('admin.academic-years.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year') }}" placeholder="2026" min="2000" max="2099" required>
