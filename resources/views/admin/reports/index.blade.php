            ...
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reports.enrollment') }}" class="btn btn-primary btn-sm">
                        <i class="fa fa-bar-chart me-1"></i> View Report
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reports.financial') }}" class="btn btn-success btn-sm">
                        <i class="fa fa-line-chart me-1"></i> View Report
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reports.academic') }}" class="btn btn-info btn-sm">
                        <i class="fa fa-graduation-cap me-1"></i> View Report
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reports.attendance') }}" class="btn btn-warning btn-sm">
                        <i class="fa fa-clipboard me-1"></i> View Report
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reports.students') }}" class="btn btn-secondary btn-sm">
                        <i class="fa fa-list me-1"></i> View Report
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reports.faculty') }}" class="btn btn-danger btn-sm">
                        <i class="fa fa-user me-1"></i> View Report
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reports.courses') }}" class="btn btn-dark btn-sm">
                        <i class="fa fa-book me-1"></i> View Report
                    </a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.reports.fees') }}" class="btn btn-purple btn-sm">
                        <i class="fa fa-money me-1"></i> View Report
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-light">
                    <h5 class="card-title mb-0"><i class="fa fa-info-circle me-2"></i>Report Features</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <h6><i class="fa fa-filter text-primary me-2"></i>Advanced Filtering</h6>
                            <p class="text-muted small">Filter reports by date range, department, semester, academic year, and more.</p>
                        </div>
                        <div class="col-md-4">
                            <h6><i class="fa fa-file text-danger me-2"></i>PDF Export</h6>
                            <p class="text-muted small">Download any report as a PDF file for printing or sharing.</p>
                        </div>
                        <div class="col-md-4">
                            <h6><i class="fa fa-pie-chart text-success me-2"></i>Visual Analytics</h6>
